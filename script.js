$(document).ready(function () {
    ...
    let renderService = {
        ...
        newQuickCard: (data) => {
            ...
            $(".quickSort").append($(`<div class="card" style="width: 18rem;">
            <img class="card-img-top" style="width: 80px;height:80px;" src="${data.image}" alt="" id="weaponimg">
            <img class="card-img-top" src="${data.backgroundImg}" alt="" id="bgimg">
            <div class="card-body">
                <h5 class="card-title" id="weaponName">${data.name}</h5>
            </div>
        ...
        renderTableCard: (weapon) => {
            $("#bodytable").append($(`
            <tr>
                <th scope="row"><img src="${weapon.image}"></th>
                <td>${weapon.name}</td>
                <td>${weapon.rarity}</td>
                <td>${weapon.dps}</td>
